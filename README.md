...
The cloud relay validates epochs, turn ownership, sequence, hashes, sample counts, cancellation, and heartbeat state. Generated PCM uses bounded rolling storage and begins after 500 ms of contiguous validated audio. Walle’s active constitution is versioned as `walle-warm-curious-v1`.
